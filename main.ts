...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (controller.up.isPressed()) {
        tiles.setTileAt(tiles.getTileLocation(mySprite.x / 16 + 0, mySprite.y / 16 - 1), assets.tile`transparency16`)
        tiles.setWallAt(tiles.getTileLocation(mySprite.x / 16 + 0, mySprite.y / 16 - 1), false)
    } else if (controller.down.isPressed()) {
        tiles.setTileAt(tiles.getTileLocation(mySprite.x / 16 + 0, mySprite.y / 16 + 1), assets.tile`transparency16`)
        tiles.setWallAt(tiles.getTileLocation(mySprite.x / 16 + 0, mySprite.y / 16 + 1), false)
    } else if (muki == "右") {
        tiles.setTileAt(tiles.getTileLocation(mySprite.x / 16 + 1, mySprite.y / 16 + 0), assets.tile`transparency16`)
        tiles.setWallAt(tiles.getTileLocation(mySprite.x / 16 + 1, mySprite.y / 16 + 0), false)
    } else if (muki == "左") {
        tiles.setTileAt(tiles.getTileLocation(mySprite.x / 16 + -1, mySprite.y / 16 + 0), assets.tile`transparency16`)
        tiles.setWallAt(tiles.getTileLocation(mySprite.x / 16 + -1, mySprite.y / 16 + 0), false)
    }
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (controller.down.isPressed()) {
        tiles.setTileAt(tiles.getTileLocation(mySprite.x / 16 + 0, mySprite.y / 16 + 1), sprites.builtin.brick)
        tiles.setWallAt(tiles.getTileLocation(mySprite.x / 16 + 0, mySprite.y / 16 + 1), true)
    } else if (controller.up.isPressed()) {
        tiles.setTileAt(tiles.getTileLocation(mySprite.x / 16 + 0, mySprite.y / 16 - 1), sprites.builtin.brick)
        tiles.setWallAt(tiles.getTileLocation(mySprite.x / 16 + 0, mySprite.y / 16 - 1), true)
    } else if (muki == "右") {
        tiles.setTileAt(tiles.getTileLocation(mySprite.x / 16 + 1, mySprite.y / 16 + 0), sprites.builtin.brick)
        tiles.setWallAt(tiles.getTileLocation(mySprite.x / 16 + 1, mySprite.y / 16 + 0), true)
    } else if (muki == "左") {
        tiles.setTileAt(tiles.getTileLocation(mySprite.x / 16 + -1, mySprite.y / 16 + 0), sprites.builtin.brick)
        tiles.setWallAt(tiles.getTileLocation(mySprite.x / 16 + -1, mySprite.y / 16 + 0), true)
    }
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`prevDoor`, function (sprite, location) {
    ステージ移動(-1)
})
...
function ステージ移動 (direction: number) {
    if (direction == 1) {
        stage += 1
    } else if (direction == -1) {
        stage += -1
    ...
    if (stage == 1) {
        ...
        if (direction == 1) {
            ...
            tiles.placeOnTile(mySprite, tiles.getTileLocation(12, 10))
        }
    } else if (stage == 2) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`nextDoor`, function (sprite, location) {
    ステージ移動(1)
})
let muki = ""
let stage = 0
